...
<div class="wrapper">
        ...
        <form class="flex-auto container shadow-xl w-64 bg-green-600 border-8 border-black rounded-lg pl-8 mb-8" action="Verwerking.php?action=mwlogin" method="post">
