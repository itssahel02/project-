...
<div x-data="{ cartOpen: false , isOpen: false }" class="bg-white">
    ...
    <div class="container wrapper object-center">
    <h2>Register</h2>
        <p>Please fill in the registration form</p>

        <form class="flex-auto container shadow-xl w-64 bg-green-600 border-8 border-black rounded-lg pl-8 mb-8" action="Verwerking.php?action=register" method="post">
        ...
        <form class="flex-auto container shadow-xl w-64 bg-green-600 border-8 border-black rounded-lg pl-8 mb-8" action="Verwerking.php?action=login" method="post">
            <div class="form-group">
                <label>Username</label>
                <input type="text" name="username" required></input>
            </div>    
...
<br class="py-8">
    <a href="mwlogin.php" class="flex-auto container bg-green-600 text-gray-900 text-xl rounded-lg py-8 px-4 ">medewerkers inlogpagina</a>
